...
public class ToastUtil {
    ...
    public static void showShortToast(String msg) {
        if(FeedbackApplication.getApp() != null){
            if (toast == null) {
                toast = Toast.makeText(FeedbackApplication.getApp(), msg, Toast.LENGTH_SHORT);
            } else {
                toast.setText(msg);
            }
            ...
            toast.setGravity(Gravity.BOTTOM, 0, dip2px(FeedbackApplication.getApp(),64));
            toast.show();
        }
    }
    /**
    ...
    public static void showLongToast(String msg) {
        if(FeedbackApplication.getApp()!= null) {
            if (toast == null) {
                toast = Toast.makeText(FeedbackApplication.getApp(), msg, Toast.LENGTH_LONG);
            } else {
                toast.setText(msg);
            }
            toast.setGravity(Gravity.BOTTOM, 0, dip2px(FeedbackApplication.getApp(),64));
