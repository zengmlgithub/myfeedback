...
public class HasModifiedAdapter extends BaseExpandableListAdapter {

   private Context mContext;
   private List<WaitingModifiedBean> beanList;

    public HasModifiedAdapter(Context mContext, List<WaitingModifiedBean> beanList) {
